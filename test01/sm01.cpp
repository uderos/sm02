...
static const sm_base_t::trans_table_t sm01_trans_table {
  sm_base_t::trans_table_row_t(STATE_IDLE,  EVENT_ID_ONE, STATE_ONE                                        ),
  sm_base_t::trans_table_row_t(STATE_ONE,   EVENT_ID_TWO, STATE_TWO                                        ),
  sm_base_t::trans_table_row_t(STATE_TWO,   EVENT_ID_END, STATE_END,    result_guard_fn                    ),
  sm_base_t::trans_table_row_t(STATE_TWO,   EVENT_ID_END, STATE_ERROR                                      ),
};
